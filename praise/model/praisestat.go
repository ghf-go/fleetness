...
type PraiseStat struct {
	...
	TargetCounts uint64    `gorm:"column:target_counts;default:0;NOT NULL" json:"target_counts"`            // 点赞次数
...
func (m *PraiseStat) TableName() string {
	return "t_praise_stat"
}
