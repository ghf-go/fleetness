...
type Category struct {
	...
	TargetType int       `gorm:"column:target_type;default:0;NOT NULL" json:"target_type"`             // 目标类型
	ParentID   uint64    `gorm:"column:parent_id;default:0;NOT NULL" json:"parent_id"`                 // 上级分类ID
