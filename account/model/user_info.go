...
type UserInfo struct {
	...
	Ukey     string    `gorm:"column:ukey;NOT NULL" json:"ukey"`
	Uval     string    `gorm:"column:uval;NOT NULL" json:"uval"`                                     // 内容
	Newval   string    `gorm:"column:newval;NOT NULL" json:"newval"`                                 // 新内容
	IsAudit  int       `gorm:"column:is_audit;default:0;NOT NULL" json:"is_audit"`                   // 是否已审核
