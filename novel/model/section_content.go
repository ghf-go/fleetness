...
// 小说章节内容
type NovelSectionContent struct {
	ID        uint64    `gorm:"column:id;primary_key;AUTO_INCREMENT" json:"id"`
	SectionID uint64    `gorm:"column:section_id;default:0;NOT NULL" json:"section_id"`               // 章节ID
	Content   string    `gorm:"column:content;NOT NULL" json:"content"`                               // 章节内容
...
func (m *NovelSectionContent) TableName() string {
	return "t_novel_section_content"
}
